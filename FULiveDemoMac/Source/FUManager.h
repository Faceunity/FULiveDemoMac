...
@protocol FUManagerDelegate <NSObject>
...
@property (nonatomic, weak) id<FUManagerDelegate> delegate;
...
@property (nonatomic, strong)               NSMutableDictionary<NSString *,NSNumber *> *filtersLevel;
