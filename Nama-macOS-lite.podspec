Pod::Spec.new do |s|
  ...
  s.version  = '5.4.0'
  s.license  = 'MIT'
  s.summary  = 'faceunity nama macOS v5.4.0-dev-lite'
  s.homepage = 'https://github.com/Faceunity/FULiveDemoMac/tree/dev'
  s.author   = { 'faceunity' => 'dev@faceunity.com' }
  s.platform     = :osx, "10.8"
  s.source   = { :git => 'https://github.com/Faceunity/FULiveDemoMac.git', :tag => 'v5.4.0-dev' }
  s.source_files = 'FULiveDemoMac/Faceunity/FaceUnity-SDK-Mac-lite/**/*.{h,m}'
  s.resources = 'FULiveDemoMac/Faceunity/FaceUnity-SDK-Mac-lite/**/*.{bundle,txt}'
