...
```
pod 'Nama-macOS', '6.1.0' 
```

不含物理引擎的版本（lite版）：

```
pod 'Nama-macOS-lite', '6.1.0' 
```
...
全功能版本：[FaceUnity-SDK-Mac-v6.1.0.zip](https://www.faceunity.com/sdk/FaceUnity-SDK-Mac-v6.1.0.zip)

不含物理引擎的版本（lite版）：[FaceUnity-SDK-Mac-v6.1.0-lite.zip](https://www.faceunity.com/sdk/FaceUnity-SDK-Mac-v6.1.0-lite.zip)
...
使用细节请参考[美妆bundle参数说明](美妆道具功能文档.md)，同时参考 FULiveDemoMac 中的示例代码。
