...
```
pod 'Nama-macOS', '7.1.0' 
```

不含物理引擎的版本（lite版）：

```
pod 'Nama-macOS-lite', '7.1.0' 
```
...
全功能版本：[FaceUnity-SDK-Mac-v7.1.0.zip](https://www.faceunity.com/sdk/FaceUnity-SDK-Mac-v7.1.0.zip)

不含物理引擎的版本（lite版）：[FaceUnity-SDK-Mac-v7.1.0-lite.zip](https://www.faceunity.com/sdk/FaceUnity-SDK-Mac-v7.1.0-lite.zip)
